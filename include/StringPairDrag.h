...
public:
	...
	StringPairDrag(QWidget * w);
	Qt::DropAction exec(const QString & key, const QString & value, const QPixmap & icon,
			const Qt::DropActions supported_actions, const Qt::DropAction default_action);
	~StringPairDrag();
